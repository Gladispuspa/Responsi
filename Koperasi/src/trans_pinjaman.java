...
public class trans_pinjaman extends javax.swing.JFrame {
    ...
    private void bcariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bcariActionPerformed
        ...
        try {
            ...
            if (con.rs.next()) {
                tnopin.setText(con.rs.getString(1));
                ttgl.setText(con.rs.getString(2));
                tnoang.setText(con.rs.getString(3));
                tket.setText(con.rs.getString(4));
                tpinj.setText(con.rs.getString(5));
                tlama.setText(con.rs.getString(6));
                tpersenbunga.setText(con.rs.getString(7));
                tpersenadmin.setText(con.rs.getString(8));
                tjmlbunga.setText(con.rs.getString(9));
                ttotal.setText(con.rs.getString(10));
